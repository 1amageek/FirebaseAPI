...
public struct Google_Firestore_V1_StructuredQuery: @unchecked Sendable {
  ...
  public struct CollectionSelector: Sendable {
    // SwiftProtobuf.Message conformance is added in an extension below. See the
    // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
    // methods supported on all messages.
  ...
  public struct UnaryFilter: Sendable {
    // SwiftProtobuf.Message conformance is added in an extension below. See the
    // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
    // methods supported on all messages.
    ...
    /// The argument to the filter.
    public enum OneOf_OperandType: Equatable, Sendable {
      /// The field to which to apply the operator.
  ...
  public struct FieldReference: Sendable {
    // SwiftProtobuf.Message conformance is added in an extension below. See the
    // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
    // methods supported on all messages.
  ...
  /// between queries.
  public struct FindNearest: Sendable {
    // SwiftProtobuf.Message conformance is added in an extension below. See the
    // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
    // methods supported on all messages.
    ...
    public enum DistanceMeasure: SwiftProtobuf.Enum, Swift.CaseIterable {
      public typealias RawValue = Int
...
public struct Google_Firestore_V1_StructuredAggregationQuery: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
  ...
  public struct Aggregation: Sendable {
    ...
    /// The type of aggregation to perform, required.
    public enum OneOf_Operator: Equatable, Sendable {
      /// Count aggregator.
...
public struct Google_Firestore_V1_Cursor: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
