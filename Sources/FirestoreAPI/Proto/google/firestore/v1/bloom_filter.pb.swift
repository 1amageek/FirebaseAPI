...
public struct Google_Firestore_V1_BitSequence {
...
public struct Google_Firestore_V1_BloomFilter {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
extension Google_Firestore_V1_BitSequence: @unchecked Sendable {}
extension Google_Firestore_V1_BloomFilter: @unchecked Sendable {}
