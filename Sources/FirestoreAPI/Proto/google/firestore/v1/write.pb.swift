...
public struct Google_Firestore_V1_DocumentTransform: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
  ...
  public struct FieldTransform: Sendable {
    // SwiftProtobuf.Message conformance is added in an extension below. See the
    // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
    // methods supported on all messages.
    ...
    /// The transformation to apply on the field.
    public enum OneOf_TransformType: Equatable, Sendable {
      /// Sets the field to the given server value.
    ...
    public enum ServerValue: SwiftProtobuf.Enum, Swift.CaseIterable {
      ...
      public static let allCases: [Google_Firestore_V1_DocumentTransform.FieldTransform.ServerValue] = [
        .unspecified,
        .requestTime,
      ]
...
public struct Google_Firestore_V1_DocumentChange: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
public struct Google_Firestore_V1_DocumentDelete: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
/// affected.
public struct Google_Firestore_V1_DocumentRemove: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
public struct Google_Firestore_V1_ExistenceFilter: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
  ...
  public var unchangedNames: Google_Firestore_V1_BloomFilter {
    get {return _unchangedNames ?? Google_Firestore_V1_BloomFilter()}
    set {_unchangedNames = newValue}
  }
  /// Returns true if `unchangedNames` has been explicitly set.
  public var hasUnchangedNames: Bool {return self._unchangedNames != nil}
  /// Clears the value of `unchangedNames`. Subsequent reads from it will return its default value.
  public mutating func clearUnchangedNames() {self._unchangedNames = nil}
