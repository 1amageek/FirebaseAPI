...
public struct Google_Firestore_V1_ExplainOptions {
...
public struct Google_Firestore_V1_ExplainMetrics {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
/// Planning phase information for the query.
public struct Google_Firestore_V1_PlanSummary {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
public struct Google_Firestore_V1_ExecutionStats {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
extension Google_Firestore_V1_ExplainOptions: @unchecked Sendable {}
extension Google_Firestore_V1_ExplainMetrics: @unchecked Sendable {}
extension Google_Firestore_V1_PlanSummary: @unchecked Sendable {}
extension Google_Firestore_V1_ExecutionStats: @unchecked Sendable {}
