...
/**
 ...
 The `QueryDocumentSnapshot` struct provides methods for retrieving data and metadata for a specific Firestore document returned by a query.
 */
public struct QueryDocumentSnapshot: Identifiable, Sendable {
    ...
    /// A boolean value indicating whether the query result document exists.
    ...
    package init(fields: [String: FirestoreDocumentValue], documentReference: DocumentReference) {
        self.fields = fields
        self.documentReference = documentReference
    }

    public init(data: [String: Any], documentReference: DocumentReference) throws {
        self.init(
