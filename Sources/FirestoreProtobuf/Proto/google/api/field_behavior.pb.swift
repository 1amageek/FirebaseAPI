...
package nonisolated enum Google_Api_FieldBehavior: SwiftProtobuf.Enum, Swift.CaseIterable {
  ...
  package static let allCases: [Google_Api_FieldBehavior] = [
    .unspecified,
    .optional,
    .required,
    .outputOnly,
...
nonisolated extension SwiftProtobuf.Google_Protobuf_FieldOptions {
  ...
  package var Google_Api_fieldBehavior: [Google_Api_FieldBehavior] {
...
package nonisolated let Google_Api_FieldBehavior_Extensions: SwiftProtobuf.SimpleExtensionMap = [
...
///     [(google.api.field_behavior) = OUTPUT_ONLY,
///      (google.api.field_behavior) = IMMUTABLE];
package nonisolated let Google_Api_Extensions_field_behavior = SwiftProtobuf.MessageExtension<SwiftProtobuf.RepeatedEnumExtensionField<Google_Api_FieldBehavior>, SwiftProtobuf.Google_Protobuf_FieldOptions>(
...
nonisolated extension Google_Api_FieldBehavior: SwiftProtobuf._ProtoNameProviding {
  package static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{2}\0FIELD_BEHAVIOR_UNSPECIFIED\0\u{1}OPTIONAL\0\u{1}REQUIRED\0\u{1}OUTPUT_ONLY\0\u{1}INPUT_ONLY\0\u{1}IMMUTABLE\0\u{1}UNORDERED_LIST\0\u{1}NON_EMPTY_DEFAULT\0\u{1}IDENTIFIER\0")
}
