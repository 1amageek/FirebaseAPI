...
///       pattern: "organizations/{organization}/logs/{log}"
///       pattern: "billingAccounts/{billing_account}/logs/{log}"
package nonisolated struct Google_Api_ResourceDescriptor: Sendable {
  ...
  package var nameField: String = String()
  ...
  ///       };
  ///     }
  package var history: Google_Api_ResourceDescriptor.History = .unspecified
  ...
  /// https://aip.dev/156
  package var plural: String = String()

  /// The same concept of the `singular` field in k8s CRD spec
  /// https://kubernetes.io/docs/tasks/access-kubernetes-api/custom-resources/custom-resource-definitions/
  /// Such as "project" for the `resourcemanager.googleapis.com/Project` type.
  package var singular: String = String()

  /// Style flag(s) for this resource.
  /// These indicate that a resource is expected to conform to a given
  /// style. See the specific style flags for additional information.
  package var style: [Google_Api_ResourceDescriptor.Style] = []

  package var unknownFields = SwiftProtobuf.UnknownStorage()

  /// A description of the historical or future-looking state of the
  /// resource pattern.
  package nonisolated enum History: SwiftProtobuf.Enum, Swift.CaseIterable {
    ...
    package static let allCases: [Google_Api_ResourceDescriptor.History] = [
      .unspecified,
  ...
  package nonisolated enum Style: SwiftProtobuf.Enum, Swift.CaseIterable {
    package typealias RawValue = Int
    ...
    // The compiler won't synthesize support with the UNRECOGNIZED case.
    package static let allCases: [Google_Api_ResourceDescriptor.Style] = [
      .unspecified,
      .declarativeFriendly,
    ]
...
/// an API resource.
package nonisolated struct Google_Api_ResourceReference: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
  ...
  ///       };
  ///     }
  package var childType: String = String()
...
nonisolated extension SwiftProtobuf.Google_Protobuf_FieldOptions {
  ...
  /// [ResourceReference][].
  package var Google_Api_resourceReference: Google_Api_ResourceReference {
  ...
  package var hasGoogle_Api_resourceReference: Bool {
  ...
  package mutating func clearGoogle_Api_resourceReference() {
...
nonisolated extension SwiftProtobuf.Google_Protobuf_FileOptions {
  ...
  package var Google_Api_resourceDefinition: [Google_Api_ResourceDescriptor] {
...
nonisolated extension SwiftProtobuf.Google_Protobuf_MessageOptions {
  ...
  /// [ResourceDescriptor][].
  package var Google_Api_resource: Google_Api_ResourceDescriptor {
...
package nonisolated let Google_Api_Resource_Extensions: SwiftProtobuf.SimpleExtensionMap = [
...
/// An annotation that describes a resource reference, see
/// [ResourceReference][].
package nonisolated let Google_Api_Extensions_resource_reference = SwiftProtobuf.MessageExtension<SwiftProtobuf.OptionalMessageExtensionField<Google_Api_ResourceReference>, SwiftProtobuf.Google_Protobuf_FieldOptions>(
...
/// An annotation that describes a resource definition without a corresponding
/// message; see [ResourceDescriptor][].
package nonisolated let Google_Api_Extensions_resource_definition = SwiftProtobuf.MessageExtension<SwiftProtobuf.RepeatedMessageExtensionField<Google_Api_ResourceDescriptor>, SwiftProtobuf.Google_Protobuf_FileOptions>(
...
/// An annotation that describes a resource definition, see
/// [ResourceDescriptor][].
package nonisolated let Google_Api_Extensions_resource = SwiftProtobuf.MessageExtension<SwiftProtobuf.OptionalMessageExtensionField<Google_Api_ResourceDescriptor>, SwiftProtobuf.Google_Protobuf_MessageOptions>(
  _protobuf_fieldNumber: 1053,
...
nonisolated extension Google_Api_ResourceDescriptor: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  package static let protoMessageName: String = _protobuf_package + ".ResourceDescriptor"
  package static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{1}type\0\u{1}pattern\0\u{3}name_field\0\u{1}history\0\u{1}plural\0\u{1}singular\0\u{2}\u{4}style\0")
  ...
  package static func ==(lhs: Google_Api_ResourceDescriptor, rhs: Google_Api_ResourceDescriptor) -> Bool {
...
nonisolated extension Google_Api_ResourceDescriptor.History: SwiftProtobuf._ProtoNameProviding {
  package static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{2}\0HISTORY_UNSPECIFIED\0\u{1}ORIGINALLY_SINGLE_PATTERN\0\u{1}FUTURE_MULTI_PATTERN\0")
}

nonisolated extension Google_Api_ResourceDescriptor.Style: SwiftProtobuf._ProtoNameProviding {
  package static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{2}\0STYLE_UNSPECIFIED\0\u{1}DECLARATIVE_FRIENDLY\0")
}
...
nonisolated extension Google_Api_ResourceReference: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  package static let protoMessageName: String = _protobuf_package + ".ResourceReference"
  package static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{1}type\0\u{3}child_type\0")
  ...
  package static func ==(lhs: Google_Api_ResourceReference, rhs: Google_Api_ResourceReference) -> Bool {
    if lhs.type != rhs.type {return false}
