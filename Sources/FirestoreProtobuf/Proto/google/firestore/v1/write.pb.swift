...
package nonisolated struct Google_Firestore_V1_Write: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.

  /// The operation to execute.
  package var operation: Google_Firestore_V1_Write.OneOf_Operation? = nil

  /// A document to write.
  package var update: Google_Firestore_V1_Document {
    get {
  ...
  package var transform: Google_Firestore_V1_DocumentTransform {
    get {
  ...
  package var updateTransforms: [Google_Firestore_V1_DocumentTransform.FieldTransform] = []
...
package nonisolated struct Google_Firestore_V1_DocumentTransform: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.

  /// The name of the document to transform.
  package var document: String = String()

  /// The list of transformations to apply to the fields of the document, in
  /// order.
  /// This must not be empty.
  package var fieldTransforms: [Google_Firestore_V1_DocumentTransform.FieldTransform] = []

  package var unknownFields = SwiftProtobuf.UnknownStorage()

  /// A transformation of a field of the document.
  package nonisolated struct FieldTransform: Sendable {
    // SwiftProtobuf.Message conformance is added in an extension below. See the
    // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
    // methods supported on all messages.
    ...
    package var transformType: Google_Firestore_V1_DocumentTransform.FieldTransform.OneOf_TransformType? = nil

    /// Sets the field to the given server value.
    package var setToServerValue: Google_Firestore_V1_DocumentTransform.FieldTransform.ServerValue {
      get {
    ...
    package var increment: Google_Firestore_V1_Value {
      get {
    ...
    package var maximum: Google_Firestore_V1_Value {
      get {
    ...
    package var minimum: Google_Firestore_V1_Value {
      get {
    ...
    package var appendMissingElements: Google_Firestore_V1_ArrayValue {
      get {
    ...
    ///
    /// The corresponding transform_result will be the null value.
    package var removeAllFromArray: Google_Firestore_V1_ArrayValue {
      get {
    ...
    /// The transformation to apply on the field.
    package nonisolated enum OneOf_TransformType: Equatable, Sendable {
      /// Sets the field to the given server value.
    ...
    package nonisolated enum ServerValue: SwiftProtobuf.Enum, Swift.CaseIterable {
      ...
      package static let allCases: [Google_Firestore_V1_DocumentTransform.FieldTransform.ServerValue] = [
        .unspecified,
        .requestTime,
      ]
...
package nonisolated struct Google_Firestore_V1_WriteResult: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
  ...
  /// in the same order.
  package var transformResults: [Google_Firestore_V1_Value] = []
...
package nonisolated struct Google_Firestore_V1_DocumentChange: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
  ...
  package var removedTargetIds: [Int32] = []
...
package nonisolated struct Google_Firestore_V1_DocumentDelete: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
/// affected.
package nonisolated struct Google_Firestore_V1_DocumentRemove: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
package nonisolated struct Google_Firestore_V1_ExistenceFilter: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
  ...
  package var unchangedNames: Google_Firestore_V1_BloomFilter {
    get {_unchangedNames ?? Google_Firestore_V1_BloomFilter()}
    set {_unchangedNames = newValue}
  }
  /// Returns true if `unchangedNames` has been explicitly set.
  package var hasUnchangedNames: Bool {self._unchangedNames != nil}
  /// Clears the value of `unchangedNames`. Subsequent reads from it will return its default value.
  package mutating func clearUnchangedNames() {self._unchangedNames = nil}

  package var unknownFields = SwiftProtobuf.UnknownStorage()

  package init() {}

  fileprivate var _unchangedNames: Google_Firestore_V1_BloomFilter? = nil
}
...
nonisolated extension Google_Firestore_V1_Write: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  package static let protoMessageName: String = _protobuf_package + ".Write"
  package static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{1}update\0\u{1}delete\0\u{3}update_mask\0\u{3}current_document\0\u{2}\u{2}transform\0\u{3}update_transforms\0")
  ...
  package static func ==(lhs: Google_Firestore_V1_Write, rhs: Google_Firestore_V1_Write) -> Bool {
...
nonisolated extension Google_Firestore_V1_DocumentTransform: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  package static let protoMessageName: String = _protobuf_package + ".DocumentTransform"
  package static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{1}document\0\u{3}field_transforms\0")
  ...
  package static func ==(lhs: Google_Firestore_V1_DocumentTransform, rhs: Google_Firestore_V1_DocumentTransform) -> Bool {
...
nonisolated extension Google_Firestore_V1_DocumentTransform.FieldTransform: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  package static let protoMessageName: String = Google_Firestore_V1_DocumentTransform.protoMessageName + ".FieldTransform"
  package static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{3}field_path\0\u{3}set_to_server_value\0\u{1}increment\0\u{1}maximum\0\u{1}minimum\0\u{3}append_missing_elements\0\u{3}remove_all_from_array\0")
  ...
  package static func ==(lhs: Google_Firestore_V1_DocumentTransform.FieldTransform, rhs: Google_Firestore_V1_DocumentTransform.FieldTransform) -> Bool {
...
nonisolated extension Google_Firestore_V1_DocumentTransform.FieldTransform.ServerValue: SwiftProtobuf._ProtoNameProviding {
  package static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{2}\0SERVER_VALUE_UNSPECIFIED\0\u{1}REQUEST_TIME\0")
}

nonisolated extension Google_Firestore_V1_WriteResult: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  package static let protoMessageName: String = _protobuf_package + ".WriteResult"
  package static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{3}update_time\0\u{3}transform_results\0")
  ...
  package static func ==(lhs: Google_Firestore_V1_WriteResult, rhs: Google_Firestore_V1_WriteResult) -> Bool {
...
nonisolated extension Google_Firestore_V1_DocumentChange: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  package static let protoMessageName: String = _protobuf_package + ".DocumentChange"
  package static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{1}document\0\u{4}\u{4}target_ids\0\u{3}removed_target_ids\0")
  ...
  package static func ==(lhs: Google_Firestore_V1_DocumentChange, rhs: Google_Firestore_V1_DocumentChange) -> Bool {
...
nonisolated extension Google_Firestore_V1_DocumentDelete: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  package static let protoMessageName: String = _protobuf_package + ".DocumentDelete"
  package static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{1}document\0\u{4}\u{3}read_time\0\u{4}\u{2}removed_target_ids\0")
  ...
  package static func ==(lhs: Google_Firestore_V1_DocumentDelete, rhs: Google_Firestore_V1_DocumentDelete) -> Bool {
    if lhs.document != rhs.document {return false}
    if lhs.removedTargetIds != rhs.removedTargetIds {return false}
...
nonisolated extension Google_Firestore_V1_DocumentRemove: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  package static let protoMessageName: String = _protobuf_package + ".DocumentRemove"
  package static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{1}document\0\u{3}removed_target_ids\0\u{4}\u{2}read_time\0")
  ...
  package static func ==(lhs: Google_Firestore_V1_DocumentRemove, rhs: Google_Firestore_V1_DocumentRemove) -> Bool {
    if lhs.document != rhs.document {return false}
    if lhs.removedTargetIds != rhs.removedTargetIds {return false}
    if lhs._readTime != rhs._readTime {return false}
    if lhs.unknownFields != rhs.unknownFields {return false}
...
nonisolated extension Google_Firestore_V1_ExistenceFilter: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  package static let protoMessageName: String = _protobuf_package + ".ExistenceFilter"
  package static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{3}target_id\0\u{1}count\0\u{3}unchanged_names\0")
  ...
  package mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      case 3: try { try decoder.decodeSingularMessageField(value: &self._unchangedNames) }()
      default: break
      }
    }
  }
  ...
  package func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
    ...
    try { if let v = self._unchangedNames {
      try visitor.visitSingularMessageField(value: v, fieldNumber: 3)
    } }()
    try unknownFields.traverse(visitor: &visitor)
  }

  package static func ==(lhs: Google_Firestore_V1_ExistenceFilter, rhs: Google_Firestore_V1_ExistenceFilter) -> Bool {
    if lhs.targetID != rhs.targetID {return false}
    if lhs.count != rhs.count {return false}
    if lhs._unchangedNames != rhs._unchangedNames {return false}
    if lhs.unknownFields != rhs.unknownFields {return false}
    return true
  }
}
