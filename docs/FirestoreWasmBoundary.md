...
| `FirestoreMongoCore` | Mongo-compatible query/index document builders |
...
| `FirestoreAdmin` | Transport-agnostic server-side Admin workflow facade |
...
```mermaid
flowchart TD
  A["WASI app"] --> B["FirestoreAdminServer / FirestoreAPI"]
