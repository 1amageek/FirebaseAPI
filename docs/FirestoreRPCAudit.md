...
| Mongo-compatible API | Keep `$near` and `2dsphere` support in `FirestoreMongo` and future Mongo-compatible facade/transport work rather than extending Native `QueryPredicate`. |
